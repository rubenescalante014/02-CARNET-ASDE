...
{
    public partial class Carnet_Honorifico : Form
    {
        public Carnet_Honorifico()
        {
            InitializeComponent();
        }
        ...
        private void departamento_Enter(object sender, EventArgs e)
        {
            if (departamento.Text == "#DIRECCION")
            {
                departamento.Text = "";
            }
        }

        private void departamento_Leave(object sender, EventArgs e)
        {
            if (departamento.Text == "")
            {
                departamento.Text = "#DIRECCION";
            }
        }

        private void cedula_Enter(object sender, EventArgs e)
        {
            if (cedula.Text == "#CEDULA")
            {
                cedula.Text = "";
            }
        }
        ...
        private void Carnet_Honorifico_Load(object sender, EventArgs e)
        {
